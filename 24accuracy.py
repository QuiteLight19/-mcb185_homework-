...
def f1scoreacc(a, b, c, d): # a = true +, b= false +, c is true - d is false -
	...
	if   a > 1: return 'value must be between 0 and 1'
	elif b > 1: return 'value must be between 0 and 1'
	elif c > 1: return 'value must be between 0 and 1'
	elif d > 1: return 'value must be between 0 and 1'
